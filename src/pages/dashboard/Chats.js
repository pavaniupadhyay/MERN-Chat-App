...
const ChatElement=({id, name,time,img,msg,unread,online})=>{
  ...
  return(
    ...
    >
      ...
      <Stack spacing={0} justifyContent={"center"} paddingLeft={3}>
...
<SearchIconWrapper>
  ...
  <StyledInputBase placeholder="Search..." inputProps={{"aeia-label" :"search"}}/>
</Search>
</Stack>
        </Stack>
      <Stack spacing={1} padding={1.5}>
        <Stack direction="row" alignItems={"center"} spacing={1.5} paddingTop={0.1} >
        <ArchiveBox size={24}/>
       ...
       <Stack direction="column" sx={{
        ...
        <Stack spacing={2.4}>
        <Typography variant="subtitle2" sx={{color:"#676767", paddingLeft:"20px"}}>
        Pinned
      </Typography>
